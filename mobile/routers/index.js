 ...
 *  excepto para index.js. La ruta se crea de tal manera que el resultado sea http://localhost:3000/resumen, en el caso de resumen.js, y
 *  asi sucesivamente.
 * 
...
const automaticRouting = (PATH) => {
    ...
    fileNames = fileNames.filter(file => {    
        ...
        }                                           // http://localhost:3000/{nombre del archivo sin extension}
    });
};
